    ...
    switch (field.type) {
        case FieldType::Float: {
            ...
            if (field.flags & FieldFlags::Range) {
                modified = ImGui::DragFloat(field.name.c_str(), value,
                    field.metadata.dragSpeed,
                    field.metadata.rangeMin,
                    field.metadata.rangeMax);
            } else {
        ...
        case FieldType::Int: {
            ...
            if (field.flags & FieldFlags::Range) {
                modified = ImGui::DragInt(field.name.c_str(), value, 1.0f,
                    static_cast<int>(field.metadata.rangeMin),
