...
inline FieldInfo MakeFieldInfo(const std::string& name, FieldType ClassType::*memberPtr, uint32_t flags,
    ...
    info.getPtr = [memberPtr](void* obj) -> void* { return &(static_cast<ClassType*>(obj)->*memberPtr); };

    info.getConstPtr = [memberPtr](const void* obj) -> const void* {
        return &(static_cast<const ClassType*>(obj)->*memberPtr);
    };

    info.getValue = [memberPtr](const void* obj) -> std::any { return static_cast<const ClassType*>(obj)->*memberPtr; };
...
class TypeBuilder {
public:
    explicit TypeBuilder(const std::string& typeName) : m_TypeInfo{typeName, std::type_index(typeid(T)), sizeof(T)} {}

    template <typename FieldType>
    TypeBuilder& Field(const std::string& name, FieldType T::*memberPtr,
                       uint32_t flags = FieldFlags::Public | FieldFlags::Serializable, FieldMetadata metadata = {}) {
        m_TypeInfo.AddField(MakeFieldInfo<T, FieldType>(name, memberPtr, flags, metadata));
        return *this;
    }

    void Register() { TypeRegistry::Instance().RegisterType(std::move(m_TypeInfo)); }
...
#define FIELD(FieldName) builder.Field(#FieldName, &ReflectedType::FieldName);

#define FIELD_FLAGS(FieldName, Flags) builder.Field(#FieldName, &ReflectedType::FieldName, Flags);
...
#define FIELD_RANGE(FieldName, Min, Max, Speed)                                                                        \
    builder.Field(#FieldName, &ReflectedType::FieldName,                                                               \
                  ::PiiXeL::Reflection::FieldFlags::Public | ::PiiXeL::Reflection::FieldFlags::Serializable |          \
                      ::PiiXeL::Reflection::FieldFlags::Range,                                                         \
                  ::PiiXeL::Reflection::FieldMetadata{Min, Max, Speed});

#define FIELD_ENTITY(FieldName)                                                                                        \
    builder.Field(#FieldName, &ReflectedType::FieldName,                                                               \
                  ::PiiXeL::Reflection::FieldFlags::Public | ::PiiXeL::Reflection::FieldFlags::Serializable |          \
                      ::PiiXeL::Reflection::FieldFlags::EntityPicker);
